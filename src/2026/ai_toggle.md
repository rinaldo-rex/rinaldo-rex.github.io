...
The interesting thing about LLMs are - that they love to extract something out of anything. It's becuase that's their inherent nature. You remember that one guy/gal in your friend group that always loves to talk about anything and everything - The _pseudo_ know-it-all?{{note: Unfortunately, if you don't know one like that - It's probably you in the group. Don't feel bad, for we're always a know-it-all in some groups than others!}}

LLMs are like that. Here's a post I made a while back.

| ![](imgs/LLM_vocabulary.png) | 
|:--:| 
